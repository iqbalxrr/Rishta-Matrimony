...
const Navbar = () => {
  ...
  <NavLink to="/services" className="block  py-2 hover:text-blue-500">Services</NavLink>
  <NavLink to="/pricing" className="block py-2 hover:text-blue-500">Pricing</NavLink>
  <NavLink to="/contact" className="block py-2 hover:text-blue-500">Contact</NavLink>
 <button className="bg-rose-600 hover:bg-rose-700 text-white px-4 rounded-3xl "> <NavLink to="/loginpage" className="block py-2 ">Log in</NavLink></button>
</>
  );
